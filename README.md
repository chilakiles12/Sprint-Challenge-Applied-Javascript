...
2. What is an event?
   click, scroll, hover, drag and drop.
3. What is an event listener?
   Method use to create an event.
4. Why would we convert a NodeList into an Array?
   To use with forEach and iterate over each item.
5. What is a component?
   A seperate set of instructions to be reused multiple times. Easy to test independently.
